...
const DigiShalaPage = () => {
  ...
  return (
    <Layout>
      ...
      {/* ── Screen 6: Understanding AI (Dedicated Future-Proof Section) ── */}
          ...
          <AnimeReveal variant="fade-up">
            <div className="text-center max-w-3xl mx-auto mb-14">
              <span className="text-secondary text-xs font-bold tracking-[0.2em] uppercase mb-2 block">
                Documented Focus Area
              </span>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold text-white mb-4">
                Understanding AI
              </h2>
              <p className="text-xl font-serif italic text-secondary mb-6">
                Making new technology easier to understand
              </p>
              <div className="h-1 w-20 bg-secondary mx-auto mb-8 rounded-full" />
              <p className="text-white/80 text-base sm:text-lg leading-relaxed max-w-3xl mx-auto font-light">
                Artificial Intelligence is becoming part of the tools people use for learning, communication and work.
                Digi-Shala introduces girls to AI awareness so that new technology feels understandable rather than distant or intimidating.
              </p>
            </div>
          </AnimeReveal>

          {/* Visual Flow: WHAT IS AI? → WHERE DO WE SEE IT? → HOW CAN IT HELP? → HOW DO WE USE IT RESPONSIBLY? */}
                ...
                {[
                  {
                    step: "01",
                    question: "WHAT IS AI?",
                    desc: "Simple, concept-first explanations of machines learning patterns.",
                    icon: Brain,
                  },
                  {
                    step: "02",
                    question: "WHERE DO WE SEE IT?",
                    desc: "Recognizing automated features in translation, search, and daily apps.",
                    icon: Search,
                  },
                  {
                    step: "03",
                    question: "HOW CAN IT HELP?",
                    desc: "Leveraging technology for study aids, research, and skill building.",
                    icon: Lightbulb,
                  },
                  {
                    step: "04",
                    question: "RESPONSIBLE USE",
                    desc: "Critical thinking, verifying facts, and safe digital ethics.",
                    icon: ShieldCheck,
                  },
                ].map((item) => (
                  <div key={item.question} className="p-5 rounded-2xl bg-white/10 border border-white/15 text-center flex flex-col items-center hover:bg-white/15 transition-all">
                    ...
                    <h4 className="font-display font-bold text-white text-xs sm:text-sm mb-1 tracking-wider">
                      {item.question}
                    </h4>
